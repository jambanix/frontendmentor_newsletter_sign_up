...
export const Success = ({ className, email, onClick }) => {
  ...
  return (
    <section onKeyDown={onClick} className={`py-4 px-8 flex flex-col gap-8 ${className}`}>
      ...
      <div className="flex flex-grow">
        <Button ref={btn} className="self-end md:self-auto" onClick={onClick}>Dismiss message</Button>
      </div>
    </section>
  )
}